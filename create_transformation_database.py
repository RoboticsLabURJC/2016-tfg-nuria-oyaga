...
lmdb_env = lmdb.open('/home/nuria/TFG/caffe/examples/mnist/Original Net/Databases/mnist_trainDef_lmdb')
...
new_lmdb_env = lmdb.open('/home/nuria/TFG/caffe/examples/mnist/Transformation 0-1 Net/Databases/mnist_train0-1_lmdb',map_size=int(1e12))
