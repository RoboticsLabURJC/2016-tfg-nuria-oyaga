...
\subsubsection{Ejecución de la red}
	...
	\begin{figure}[H]
			\centering
			\subfigure[]{\includegraphics[width=0.45\textwidth]{figures/parselogtrain}}
			\subfigure[]{\includegraphics[width=0.45\textwidth]{figures/parselogtest}}
			\caption{Archivos \text{log} de: (a)~Entrenamiento, (b)~Evaluación.}
			\label{fig.parse}
	\end{figure}

\subsection{Componente JdeRobot clasificador} \label{sec.componente}
...
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/droidcamEscr}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.3\textwidth]{figures/droidcamMov}}
...
\begin{figure}[H]
	\begin{center}
		\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/fondoNegro}}\hspace{10pt}
		\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/fondoBlanco}}
...
\end{description}
\vspace{10pt}
\section{Efectos del aprendizaje en el rendimiento del clasificador} \label{sec.aprendizaje}
...
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/canny}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/laplacian-orig}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/laplacian-neg}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/sobel}}
...
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/rotacion}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/traslacion}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/escala}} \hspace{10pt}
	\subfigure[]{\includegraphics[width=0.16\textwidth]{figures/ruido}}
...
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/exp_basica1}} \hspace{5pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/exp_robusta1}}
...
\begin{figure}[H]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/exp_basica}} \hspace{5pt}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/exp_robusta}}
